		...
		<div class="">
			...
			<center>
				<h4>
					...
					<form action="/Blog/catalogue/author" method="post">
						<select id="sel" name="Author" required>
						...
						</select><input type="hidden" value="${type}" name="type"> <input
							type="submit" class="button button3" name="submit" id="scomment"
									class="scomment" value="Choose Author">
					</form>
			...
			<hr id="h">
			<h3>
				<span style="color: #008CBA;">Recent</span> <b><span
					style="color: #4CAF50;">${Author}</span><span>'s</span></b><span
					style="color: #008CBA;"> Posts </span><span class="glyphicon glyphicon-pencil"
