		...
		<div class="">
			...
			<div align="right">
				...
				<form action="/Login" method="post">
					<input class="button button2" id="bb2" name="Go to Author Login"
						type="submit" value="Want to Add a Blog?, Go to Author Login">
				</form>
			</div>
			<h2>
			...
			<center>
				<h4>
					Search By catalogue: <a href="/Blog/java">Java</a> | <a href="/Blog/dotNet">DotNet</a>
					| <a href="/Blog">All</a> <br> <br> Search By Author:
					<form action="/Blog/all/author" method="post">
						<select id="sel" class="dropdown" name="Author" required>
						...
						</select> <input type="submit" class="button button3" name="submit"
							id="scomment" class="scomment" value="Choose Author">
					</form>
				</h4>
			</center>
			<hr id="h">
			<h3>
				<span style="color: #008CBA;">Recent</span> <b>POSTS <span class="glyphicon glyphicon-pencil"
			...
			<c:forEach items="${blogDtoList}" var="temp">
				<div class="col-page col-sm-4 col-md-3">
                  ...
                  <img class="img-responsive" src="https://placeholdit.imgix.net/~text?txtsize=34&txt=&w=500&h=300">
						...
						<%-- 	<form action="UpdateRate" style="color: white;">
								<input type="radio" name="rating" id="str1" value="1"> 1
								<input type="radio" name="rating" id="str2" value="2"> 2
								<input type="radio" name="rating" id="str3" value="3">3
								<input type="radio" name="rating" id="str4" value="4">4
								<input type="radio" name="rating" id="str5" value="5">5
								<input type="hidden" name="Blogids" id="Blogids"
									value=${temp.blogid } /> <input type="hidden" name="frates"
									id="frates" value=${temp.rating } /> <input type="hidden"
									name="ratecs" id="ratecs" value=${temp.rateCount } /> <br>
					...
					<%-- 	<center>
							<form action="UpdateComment" method="post">
								<input type="text" id="comm" name="comment"
									placeholder="Write Comment" required> <input
									type="hidden" name="Blogids" id="Blogids" value=${temp.blogid } />
								<input type="hidden" name="tcomment" id="tcomment"
									value=${temp.tcomment } /> <input type="submit"
									class="button button2" name="scomment" id="scomment"
									class="scomment" value="Submit Comment" style="color: black;" />
							</form>
						</center> --%>
						<br> <br>
						<hr>
