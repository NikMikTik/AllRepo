...
<br>	<div align="right">
		...
		<form action="/Login" method="post">
			...
			<center>
			<h4>
				Search By catalogue: <a href="/Blog/java">Java</a> | <a href="/Blog/dotNet">DotNet</a> | <a href="/Blog">All</a>
				<br>
...
</c:forEach>					</select><input type="hidden" name="type" value="DotNet">

<input type="submit" class="button button3" name="submit" id="scomment"
	...
	<h3>
				<span style=color:#008CBA;>Recent</span> <b><span id="sps" style=color:#4CAF50;>DOTNET</span></b><span style=color:#008CBA;> Posts </span><span class="glyphicon glyphicon-pencil"
